...
api.put("/box/:_id", [md_auth.ensureAuth, md_uploadFile.single('image')], BoxController.updateBox);
api.delete("/box/:_id", md_auth.ensureAuth, BoxController.deleteBox);
api.post("/box", [md_auth.ensureAuth, md_uploadFile.single('image')], BoxController.createBox); //md_auth.ensureAuth,
